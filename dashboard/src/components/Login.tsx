...
export default function Login({ onContinue }: { onContinue: () => void }) {
  ...
  <a className="login-brand" href="#/">CoAudit</a><p className="login-lede">The audit trail for AI-authored code.</p>
  ...
  <p className="login-note">Single sign-on through your GitHub identity. CoAudit only reads repositories you install it on.</p>
  </div></main>
}
